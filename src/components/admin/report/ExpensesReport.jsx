      ...
      <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="text-right">
            ...
            <p className="text-2xl font-bold text-red-600">S/. {totalExpenses.toLocaleString()}</p>
          </div>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {data.slice(0, 20).map((expense, index) => (
                <tr key={index}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-red-600">
                    S/. {expense.amount.toLocaleString()}
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        {data.length > 20 && (
          <div className="mt-4 text-center">
            <p className="text-sm text-gray-600">
              Mostrando 20 de {data.length} gastos. Exporta el reporte para ver todos.
            </p>
          </div>
        )}
      </div>
