// src/components/admin/report/DailyReport.jsx - CORREGIDO
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-medium text-gray-900">
            Reportes Diarios ({reports.length} registros)
          </h3>
        </div>
              ...
              {reports.map((report, index) => (
                <tr key={report.id || index}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-green-600">
                    S/. {(report.total_revenue || 0).toLocaleString('es-PE', { minimumFractionDigits: 2 })}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-red-600">
                    S/. {(report.total_expenses || 0).toLocaleString('es-PE', { minimumFractionDigits: 2 })}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
